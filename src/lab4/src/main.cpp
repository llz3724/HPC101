...
extern "C" int bicgstab(int N, int world_size,int world_rank,double* A, double* b, double* x, int max_iter, double tol);
...
int main(int argc, char* argv[]) {
    ...
    int iter   = bicgstab(N, world_size,world_rank,A, b, x, MAX_ITER, TOL);
